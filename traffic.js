var apiKey = "eoyoO5587Mm44dopGhB9qwQJMJoFGZJi";
var centerCoords = [77.2197, 28.6315];
var initialZoom = 16;
var map = tt.map({
    key: apiKey,
    container: "map",
...
function enableBoundingBoxDraw() {
    showInfoPopup("Click and drag to draw a box on desired area");
...
function onMouseUp(eventDetails) {
    ...
    if (drawBoundingBoxButtonPressed) {
        ...
        if (bothLngLatAreDifferent(startCornerLngLat, endCornerLngLat)) {
            ...
            showErrorPopup("Try to select bigger box.");
...
// var suggestRoutesButton = document.getElementById("suggest-routes-button");

// function toggleSuggestRoutesButton(enable) {
//   suggestRoutesButton.disabled = !enable;
// }
...
//                 showErrorPopup("There are no traffic activities in this area 🥳🥳");
//                 hidePopup(popupHideDelayInMilis);
//             } else {
...
//                 if (results.tm.poi.length > 0) {
//                     toggleSuggestRoutesButton(true);
//                   } else {
//                     toggleSuggestRoutesButton(false);
//                   }
//             }
//         });
// }

// suggestRoutesButton.addEventListener("click", function () {
//     // Check if there are traffic incidents
//     var boundingBox =  {
//         west: -74.2591, // Longitude of the southwest corner
//         south: 40.4774, // Latitude of the southwest corner
//         east: -73.7002, // Longitude of the northeast corner
//         north: 40.9176  // Latitude of the northeast corner
//       };
//     tt.services.incidentDetails({
//       key: apiKey,
//       boundingBox: boundingBox,
...
//       .then(function (results) {
//         if (results.tm.poi.length > 0) {
//           // There are traffic incidents, suggest alternative routes
//           tt.services.routing({
//             key: apiKey,
//             locations:  [
//                 { lat: 40.748817, lon: -73.985428 }, // Start point
//                 { lat: 40.748817, lon: -74.005428 }  // End point
//               ],
//             traffic: true,
//             alternatives: true
//           })
...
//                 // Update your UI with the suggested alternative routes information
//                 console.log("Suggested Alternative Routes:", response.routes);
//                 // You can implement further UI updates or actions based on the suggested routes
//               } else {
...
//             });
//         } else {
//           // No traffic incidents, provide a message to the user
//           console.log("No traffic incidents found. Alternative routes not suggested.");
//         }
//       });
//   });
